                    ...
                    <div class="object-picker__select-group object-picker__select-group--product-options-variants-add">
                        <div class="object-picker__simple object-picker__simple--product-options-variants-add">
                            <select multiple
                                    ...
                                    data-ca-object-picker-selection-css-class="object-picker__selection-simple object-picker__selection-simple--full-width object-picker__selection-simple--product-options-variants-add"
