<div>
    <p>{__("predict.features.feature_will_be_removed_from_products.warning", [$affected_product_ids|count, "[feature]" => $feature.internal_name, "[product_search_url]" => "{fn_url("products.manage?product_ids_search_key={$product_ids_search_key}")}"])}</p>
</div>
