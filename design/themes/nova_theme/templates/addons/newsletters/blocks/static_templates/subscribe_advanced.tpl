...
<div class="ty-footer-form-block ty-footer-newsletters-block no-help">
    <form action="{""|fn_url}" method="post" name="subscribe_form" class="cm-processing-personal-data">
        ...
        <div class="ty-footer-form-block__form ty-control-group with-side">
            <h3 class="ty-social-link__title">{include_ext file="common/icon.tpl" class="ty-icon-loyalty"}{__("exclusive_promotions_short")}<span class="ty-block">{__("exclusive_promotions_content_short")}</span></h3>
        </div>
        ...
        <div class="ty-footer-form-block__form ty-control-group">
            ...
            <label class="cm-required cm-email hidden" for="subscr_email{$block.block_id}">{__("email")}</label>
                <input type="text" name="subscribe_email" id="subscr_email{$block.block_id}" size="20" placeholder="{__("email")}" class="ty-input-text-medium ty-valign-top" />
