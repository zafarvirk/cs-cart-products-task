    ...
    <div class="cm-field-container">
        {strip}
            <label for="id_accept_terms_{$field.field_name}" class="{if $field.profile_required == "Y"}cm-check-agreement{/if}">
                ...
                <a id="sw_terms_and_conditions_{$field.field_name}" class="cm-combination ty-dashed-link ty-license-agreement__link">
                    {$field.description}
                </a>
            </label>
        {/strip}

        <div class="ty-license-agreement__content hidden" id="terms_and_conditions_{$field.field_name}">
