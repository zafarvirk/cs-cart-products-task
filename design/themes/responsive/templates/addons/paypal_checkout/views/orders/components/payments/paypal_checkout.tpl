...
<input type="hidden"
       ...
       data-ca-paypal-checkout-button="{if $cart}litecheckout_place_order{else}litecheckout_repay_order{/if}"
       ...
       data-ca-paypal-checkout-total="{$paypal_checkout_cart_total}"
       data-ca-paypal-checkout-company-name="{$settings.Company.company_name}"
