...
class CheckoutHookHandler
{
     ...
     * @param bool|array<array-key, string>                                              $force_notification      List of force notification if available
     ...
     */
    public function onOrderPlacementRoutines($order_id, $force_notification, array $order_info, $_error, $redirect_url, $allow_external_redirect)
    {
        if (
