...
REPLACE INTO ?:seo_names (`name`, `object_id`, `company_id`, `type`, `dispatch`, `lang_code`) VALUES('menus', 0, 0, 's', 'menus.manage', 'en');
REPLACE INTO ?:seo_names (`name`, `object_id`, `company_id`, `type`, `dispatch`, `lang_code`) VALUES('profiles', 0, 0, 's', 'profiles.manage', 'en');
